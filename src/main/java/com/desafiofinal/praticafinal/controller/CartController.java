...
public class CartController {
    ...
    @PutMapping("/update/{purchaseId}/{sellerRating}")
    ResponseEntity<String> updateStatusRating (@PathVariable long purchaseId, @PathVariable Double sellerRating) throws Exception {
